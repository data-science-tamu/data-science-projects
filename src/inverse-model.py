...
learn_rate = 0.001
num_epochs = 1 # Each epoch is 1000 training "sessions"
...
# Calculating Loss (TODO: try and improve the efficiency of this function)
class InverseLoss(torch.nn.Module):
    ...
    def calculate_loss_r(self, pred_E, stress) -> tuple[float, float]:
        ...
        # Moved to initialization step to avoid repeatedly making
        # new tensors.
...
def main():
    ...
    def train(epoch, coordinate_data, strain_data):
        ...
        for i in range (1, 1001):
            ...
            if i % 10 == 0: #TODO: put this back to 100
    ...
    pred_E = output[:, 0]
    pred_v = output[:, 1]
    np.savetxt("pred_E.txt", pred_E.cpu())
    np.savetxt("pred_v.txt", pred_v.cpu())
